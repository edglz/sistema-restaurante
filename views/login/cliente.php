        ...
        <div class="col-lg-8 col-xl-9 d-flex align-items-center justify-content-center">
            <div class="row justify-content-center w-100 mt-1 mt-lg-0">
                <div class="col-lg-6 col-xl-3 col-md-7">
                    <div class="px-2 my-4">
                        <a class="btn btn-primary btn-lg btn-block" href="<?php echo URL; ?>menu">Ingresa como invitado</a>
                    </div>
                    <div class="card" id="loginform">
                        <div class="card-body">
                            ...
                            <a class="link link-success text-center" href="<?= URL . 'login/registrar_cliente' ?>">¿No tienes cuenta? ¡Registrate!</a>
                        </div>
                    </div>
                </div>
            </div>

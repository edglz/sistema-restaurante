                ...
                <div class="col-lg-6 col-xl-3 col-md-7">
                    <div class="card" id="loginform">
                        <div class="card-body">
                            ...
                            <p class="text-muted fs-4">Ingrese sus datos</p>
                            <form class="form-horizontal mt-4 pt-4" id="frm-cliente" role="form" method="post">
                                <input type="hidden" name="tipo_cliente" value="1">    
                            <div class="form-floating mb-3">
                                    <input type="text" required class="form-control form-input-bg" name="nombres" id="nombres" placeholder="Nombre Completo" autocomplete="off">
                                    <label for="nombres">Nombre Completo</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" required class="form-control form-input-bg" name="telefono" id="telefono" placeholder="Teléfono" autocomplete="off">
                                    <label for="telefono">Teléfono</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="date"  required class="form-control form-input-bg date" name="fecha_nac" id="fecha_nac" placeholder="Fecha de nacimiento" autocomplete="off">
                                    <label for="fecha_nac">Fecha Nacimiento</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" required class="form-control form-input-bg" name="direccion" id="direccion" placeholder="Dirección" autocomplete="off">
                                    <label for="direccion">Dirección</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" required class="form-control form-input-bg" name="usuario" id="usuario" placeholder="Usuario" autocomplete="off">
                                    <label for="usuario">Usuario</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="password" required class="form-control form-input-bg" name="pwd" id="password" placeholder="*****" autocomplete="off">
                                ...
                                <a href="<?= URL . 'login/cliente' ?>" class="btn btn-info px-4 btn-lg btn-block">Iniciar sesión</a>
                            </form>
                        </div>
                    </div>
                </div>

...
$(function() {
    ...
    .on('success.form.fv', function(e) {
        ...
        // }else if ($('#tipo_pago').val() == '3'){
            ...
            // if (Number($('#total_venta').val()) > Number($('#pago_efe').val())+Number($('#pago_tar').val())    ){
            //     console.log("monto bajo tipo 3");
            //     console.log(Number($('#total_venta').val()));
            //     console.log(Number($('#pago_efe').val())+Number($('#pago_tar').val()));
            //     Swal.fire({   
            //         title:'Advertencia',   
            ...
            //     });
            // }
        }else if (Number($('#total_venta').val()) > Number($('#pago_efe').val()) ){

            console.log("monto bajo");
            console.log(Number($('#total_venta').val()));
            console.log(Number($('#pago_efe').val()));
            Swal.fire({   
                title:'Advertencia',   
                text: 'Ingrese un monto mayor o igual al total',
                icon: "warning", 
